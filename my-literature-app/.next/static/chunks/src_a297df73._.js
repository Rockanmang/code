...
const App = ()=>{
    ...
    const filterLibraryData = (query)=>{
        ...
        const filteredGroups = libraryTree.groups.map((group)=>({
                ...group,
                documents: group.documents.filter((doc)=>doc.title.toLowerCase().includes(lowerQuery) || doc.filename.toLowerCase().includes(lowerQuery) || doc.file_type.toLowerCase().includes(lowerQuery) || doc.uploader_name.toLowerCase().includes(lowerQuery))
            }));
    ...
    const loadConversationHistory = async (sessionId)=>{
        try {
            ...
            setAiAssistant((prev)=>({
                    ...
                    conversation: historyData.conversation_turns || [],
                    isLoading: false,
                    showHistory: false
                }));
        } catch (error) {
...
_s(App, "Fc8I0kPpzuFshcdFgvKN/TeA/cQ=", false, function() {
    return [
...
//# sourceMappingURL=src_a297df73._.js.map